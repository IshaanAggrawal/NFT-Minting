...
const Footer = () => {
  return (
    <footer className="border-t border-gray-800 bg-gradient-to-r from-gray-900 via-purple-900/30 to-gray-900 backdrop-blur-sm">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            <h4 className="font-bold text-lg mb-4 text-white">Marketplace</h4>
            <ul className="space-y-3">
              <li><a href="/market" className="text-gray-400 hover:text-white transition-colors">All NFTs</a></li>
              <li><a href="/market" className="text-gray-400 hover:text-white transition-colors">Art</a></li>
              <li><a href="/market" className="text-gray-400 hover:text-white transition-colors">Music</a></li>
              <li><a href="/market" className="text-gray-400 hover:text-white transition-colors">Photography</a></li>
              <li><a href="/market" className="text-gray-400 hover:text-white transition-colors">Collectibles</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-500">
          <p>&copy; {new Date().getFullYear()} NFTMarket. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
